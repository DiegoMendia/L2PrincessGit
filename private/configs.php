...
##                   Configuración                       ##
###########################################################
$server_name = 'L2Princess'; // Server Nombre
$server_chronicle = 'Interlude'; // Server Chronicle
$server_url = 'l2princess.com.ar'; // Introduzca exactamente la URL donde se encuentra este site (por ejemplo: www.l2server.com)
...
$host = 'localhost:3307'; // Endereço do host  127.0.0.1
$dbnm = 'l2p'; // Nome do banco
$user = 'root'; // Usuário
$pass = ''; // Senha
...
##                    Server Status                      ##
###########################################################
$serverIp = '38.54.45.8'; // Server IP (para buscar el estado del servidor)
$loginPort = '9014'; // puerta de login/auth
$gamePort = '7777'; // puerta de game


// Forzar el sitio a mostrar un cierto status (on = Online | off = Offline | auto = Estado real)
$forceServerStatus = 'auto'; // Server Status (Estandar: auto)
...
###########################################################
$admin_email = ''; // E-mail que los jugadores pueden utilizar para ponerse en contacto
$server_email = 'no-reply@l2princess.com.ar'; // E-mail utilizado para enviar mensajes automáticas (por ejemplo: no-reply@suservidor.com)
...
$SMTP_host = 'smtp.l2princess.com.ar'; // Host SMTP
...
$SMTP_user = 'no-reply@l2princess.com.ar'; // Usuario de autenticación SMTP (generalmente el correo electrónico remitente)
...
$countTopPlayers = 20; // Cantidad de jugadores mostrados en los Tops PvP, Pk, Online, Level y Adena
$countTopClan = 15; // Cantidad de clanes en el Top Clan
$asideRankCount = 6; // Quantidade de resultados exibidos nos rankings na lateral do site
...
$inewsCount = 1; // Cantidad de noticias en la página principal del sitio
...
$facePage = 'https://www.facebook.com/L2Princess/'; // Página en Facebook


###########################################################
##             Página de donaciones públicas             ##
###########################################################
$coinName = 'Ticket de Donacion'; // Nombre del item donate
$coinPer = '1'; // Cantidad de coins
$coinCur = '$ARS'; // Moneda de esa cantidad
$coinCos = '10.00'; // Valor de esa cantidad
...
$bannerDelay = 1; // De cuántos en cuántos segundos los banners en la página inicial se revesan?
