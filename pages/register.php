<?php if(!$indexing) { echo "<script>document.location.replace('./');</script>"; exit; } ?><br><br><br>

<span id='accLoc'></span>
<center>
<h1 style="color: #953f4d; text-decoration: underline">REGISTRAR</h1>
</center>
	...
	<form class='usarJquery registerForm' method='POST' action='./?engine=create_account'>
		...
		<?php if($suffixActive == 1) { ?>
			...
			<label class='formpadrao' id='the_suffix'>
				<div>
					<div class='desc'> Cuenta - <?php echo $LANG[10997]; ?>:</div>
					<div class='camp'>
