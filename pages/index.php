...
<div class="atualstudioCountdown">
	<style>
		...
		#soon-glow { font-family: 'Quicksand', sans-serif; color: #FFFFFF; background: transparent; text-transform:lowercase; }
		#soon-glow .soon-label { color: #FFFFFF; text-shadow:0 0 .25rem rgba(0,0,0,.75); }
		#soon-glow .soon-ring-progress { color: #923242; background-color:rgba(0,0,0,.15); }
...
<hr />
<?php } } ?>
<!-- Countdown  FIM --><center>
<h1 style="color: #953f4d; text-decoration: underline">BIENVENIDOS</h1>
Lineage 2 Princess es un servidor totalmente gratuito.<br>
Cronica Interlude (c6) en el cual hay muchas aventuras por descubrir , es un servidor ambientado tanto para el jugador solitario, como para el que quiera jugar con sus amigos.<br>
En L2 Princess, no sera facil forjar el equipo para conseguir la victoria, tendras que usar muchas cosas que te brindara el servidor para alcanzar tu maximo poder, estan listos? <br>
Sean Bienvenidos y buena suerte en el Campo de batalla!.<br>
